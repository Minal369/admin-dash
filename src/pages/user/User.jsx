        ...
        <div className="userContainer">
            <div className="userShow">
                <div className="userShowTop">
                    <img src="https://images.pexels.com/photos/1152994/pexels-photo-1152994.jpeg?auto=compress&cs=tinysrgb&dpr=w=500" alt="" className="userShowImg"
                     />
            ...
            <div className="userUpdate">
                <spam className="userUpdateTitle">Edit</spam>
                <form className="userUpdateForm">
                    ...
                    <div className="userUpdateRight">
                        <div className="userUpdateUpload">
                            <img 
                              className="userUpdateImg" src="https://images.pexels.com/photos/1152994/pexels-photo-1152994.jpeg?auto=compress&cs=tinysrgb&  dpr=w=500" 
                              alt="" 
                            />
                            <label htmlFor="file">
